...
- **[現]** 横断部署（CTO室）にて会社全体のフロントエンドにおける評価制度・採用（新卒・中途）・事業支援（設計相談・ソースコードレビューなど）を担当
...
- 社内教育（フロントエンド）担当
- CDN設置作業
- DevOps 周りの基盤開発導入（オンプレミス50台ほどのWebサーバに NewRelic、Elasticsearch の導入及び保守・運用）
...
## 社外活動
### OSS
いくつか開発途中にバグを踏んだりして、issue として投げています。
...
現行のDMM では [tech vision](https://dmm-corp.com/technology/) のインナーブランディングのデザインもやっています。
